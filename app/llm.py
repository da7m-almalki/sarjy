...
extract = Agent(
    ...
    instructions=(
        ...
        "The context may also include their recent bookings. Use them ONLY for habit "
        "references: 'the usual' or 'same as last time' fills service and barber from the "
        "newest booking, intent=booking_info (fill its time too only if they say 'same "
        "time'). A question about past bookings still fills nothing. "
